...
theorem supplies the required expander decomposition on a cofinal subsequence.
-/
...
theorem exists_reindexed
  ...
  exact KunDecomposition.exists_reindexed_expanderDecomposition
