...
## The three external inputs that are proved here rather than cited

The paper cites four external theorems.  Three of them the formalization
proves outright, so they are inputs to the *paper* and not to the *library*.
